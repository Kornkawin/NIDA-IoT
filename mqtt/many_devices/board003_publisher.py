...
print("Running board003_publisher.py ...")
data = {'Device Name': 'board003', 'DateTime': '', 'Temperature': ''}
...
mqtt_client = mqtt.Client(mqtt.CallbackAPIVersion.VERSION1, userdata="boardLog003")
mqtt_client.on_connect = on_connect
mqtt_client.on_publish = on_publish
mqtt_client.tls_set(ca_certs=ca_certificate,
                    certfile=client_certificates["board003"],
                    keyfile=client_keys["board003"], tls_version=ssl.PROTOCOL_SSLv23)
